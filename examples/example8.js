...
export function showExample8() {
  generatorEle('button', '弹出层-可关闭', async function() {
    ...
    // await wait(1000)
    // close()
  }, document.querySelector('#guide-popover-closeable-box'), true)


  generatorEle('button', '弹出层-不可关闭', async function() {
    const { close } = guide('#guide-popover-closeable', {
      popover: {
        title: '该弹出层不可关闭',
        content: '你好',
  ...
  generatorEle('button', '弹出层-连续动画', async function() {
